...
$check_email = mysqli_query($db_connection, "SELECT `email` FROM `user` WHERE email = '$user_email'");
...
$insert_user = mysqli_query($db_connection, "INSERT INTO `user` (username, email, password) VALUES ('$username', '$user_email', '$user_hash_password')");
